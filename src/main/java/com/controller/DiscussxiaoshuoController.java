...
public class DiscussxiaoshuoController {
    ...
    public R save(@RequestBody DiscussxiaoshuoEntity discussxiaoshuo, HttpServletRequest request){
    	discussxiaoshuo.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussxiaoshuoEntity> wrapper = new EntityWrapper<DiscussxiaoshuoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussxiaoshuoService.selectCount(wrapper);
