 ...
 */
public class ZuoyewanchengxinxiModel  implements Serializable {
	...
	private String buzhishijian;
		
	/**
	 * 需完成时间
	 */
	
	private String xuwanchengshijian;
	...
	public void setBuzhishijian(String buzhishijian) {
	...
	public void setXuwanchengshijian(String xuwanchengshijian) {
	 ...
	 * 获取：需完成时间
	 */
	public String getXuwanchengshijian() {
