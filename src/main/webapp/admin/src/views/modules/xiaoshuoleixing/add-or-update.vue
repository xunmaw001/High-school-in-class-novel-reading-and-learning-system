<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="小说类型" prop="xiaoshuoleixing">
          <el-input v-model="ruleForm.xiaoshuoleixing" 
              placeholder="小说类型" clearable  :readonly="ro.xiaoshuoleixing"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoshuoleixing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoshuoleixingCrossAddOrUpdateFlag = false;
                  this.parent.search();
