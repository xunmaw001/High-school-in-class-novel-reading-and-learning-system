<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="小说类型" prop="xiaoshuoleixing">
          <el-select v-model="ruleForm.xiaoshuoleixing" placeholder="请选择小说类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="小说类型" prop="xiaoshuoleixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="小说内容" prop="xiaoshuoneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoshuoneirong" label="小说内容" prop="xiaoshuoneirong">
                    <span v-html="ruleForm.xiaoshuoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshuomingcheng = true;
          ...
          if(o=='xiaoshuoleixing'){
            this.ruleForm.xiaoshuoleixing = obj[o];
	    this.ro.xiaoshuoleixing = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.laoshixingming!=''&&json.laoshixingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/xiaoshuoleixing/xiaoshuoleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.xiaoshuoleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.xiaoshuoneirong = this.ruleForm.xiaoshuoneirong.replace(reg,'../../../ssm7i245/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
