<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属班级" prop="suoshubanji">
          <el-input v-model="ruleForm.suoshubanji" 
              placeholder="所属班级" clearable  :readonly="ro.suoshubanji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属班级" prop="suoshubanji">
              <el-input v-model="ruleForm.suoshubanji" 
                placeholder="所属班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
